...
static uint32_t CurrentLayer = LCD_BACKGROUND_LAYER;  //当前第一次层，背景层
...
static void PutPixel(int16_t x, int16_t y); //画点函数
...
void LCD_LayerInit(void)
{
  ...
  /* Pixel Format configuration*/ //像素格式配置
...
/*******************************************************************************
* 函数名称: LCD_ChipSelect();
* 功能描述: Controls LCD Chip Select (CS) pin
* 输入参数: NewState CS pin state
* 返回参数: 无
********************************************************************************/
...
/**
  ...
  *                                      0..16 if LCD_Currentfonts is Font8x16 
  * @retval None
  */
