...
#define LCD_FRAME_BUFFER       ((uint32_t)0xD0000000)  //LCD帧缓存区首地址：地址SDRAM
...
#define LCD_DISPLAY_INV_OFF      0x20    //关闭反转模式
#define LCD_DISPLAY_INV_ON       0x21    //打开反转模式
#define LCD_MEM_Read             0x2D    //存储器读
//=====================================================================================//
#define LCD_SLEEP_OUT            0x11   /* Sleep out register */  //退出睡眠模式
#define LCD_GAMMA                0x26   /* Gamma register */
#define LCD_DISPLAY_OFF          0x28   /* Display off register */      //关显示
#define LCD_DISPLAY_ON           0x29   /* Display on register */       //开显示
#define LCD_COLUMN_ADDR          0x2A   /* Colomn address register */   //列地址设置
#define LCD_PAGE_ADDR            0x2B   /* Page address register */     //行地址设置
#define LCD_GRAM                 0x2C   /* GRAM register */              //存储器写
#define LCD_MAC                  0x36   /* Memory Access Control register*/  //帧存储器的读写扫描方向
#define LCD_PIXEL_FORMAT         0x3A   /* Pixel Format register */   //像素格式设置
#define LCD_WDB                  0x51   /* Write Brightness Display register */ //写显示亮度--用于调整显示亮度的值
#define LCD_WCD                  0x53   /* Write Control Display register*/ //控制显示亮度
#define LCD_RGB_INTERFACE        0xB0   /* RGB Interface Signal Control */  //RGB接口信号控制
#define LCD_FRC                  0xB1   /* Frame Rate Control register */    //帧速率控制
#define LCD_BPC                  0xB5   /* Blanking Porch Control register*/  //消隐廊控制
#define LCD_DFC                  0xB6   /* Display Function Control register*/ //显示功能控制
#define LCD_POWER1               0xC0   /* Power Control 1 register */  //功耗控制
#define LCD_POWER2               0xC1   /* Power Control 2 register */
#define LCD_VCOM1                0xC5   /* VCOM Control 1 register */
#define LCD_VCOM2                0xC7   /* VCOM Control 2 register */
#define LCD_POWERA               0xCB   /* Power control A register */
#define LCD_POWERB               0xCF   /* Power control B register */
#define LCD_PGAMMA               0xE0   /* Positive Gamma Correction register*/ //正极伽马校准
#define LCD_NGAMMA               0xE1   /* Negative Gamma Correction register*/
#define LCD_DTCA                 0xE8   /* Driver timing control A */  //驱动时序控制A--扩展指令
#define LCD_DTCB                 0xEA   /* Driver timing control B */
#define LCD_POWER_SEQ            0xED   /* Power on sequence register */  //电源序列控制--扩展指令
#define LCD_3GAMMA_EN            0xF2   /* 3 Gamma enable register */   //使能3伽马控制--扩展指令
#define LCD_INTERFACE            0xF6   /* Interface control register */  //接口控制
#define LCD_PRC                  0xF7   /* Pump ratio control register */

/** 
  * @brief  LCD color   //颜色选项
  */ 
...
/** 
  * @brief  LCD Lines depending on the chosen fonts.  //控制线
  */
...
/** 
  * @brief LCD default font //字体
  */ 
#define LCD_DEFAULT_FONT         Font16x24

/** 
  * @brief  LCD Direction   //方向
  */ 
