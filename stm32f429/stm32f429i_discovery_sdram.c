...
/*******************************************************************************
* 函数名称: SDRAM_WriteBuffer();
* 功能描述: Writes a Entire-word buffer to the SDRAM memory. 
* 输入参数: pBuffer: pointer to buffer. 
            uwWriteAddress: SDRAM memory internal address from which the data will be 
*           written.
            uwBufferSize: number of words to write. 
* 返回参数: 无
********************************************************************************/
...
/*******************************************************************************
* 函数名称: SDRAM_ReadBuffer();
* 功能描述: Reads data buffer from the SDRAM memory. 
* 输入参数: pBuffer: pointer to buffer. 
            ReadAddress: SDRAM memory internal address from which the data will be 
*           read.
            uwBufferSize: number of words to write. 
* 返回参数: 无
********************************************************************************/
